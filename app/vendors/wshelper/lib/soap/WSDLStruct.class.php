...
class WSDLStruct {
	 ...
	 * @return void
	 */
	public function __construct($tns, $actionUrl, $url, $type = SOAP_RPC, $use = SOAP_ENCODED){
	...
	private function addOperation($operationName, $serviceName){
		...
		$soapOperationTag->setAttribute("soapAction",$this->action_url."&method=".$operationName);

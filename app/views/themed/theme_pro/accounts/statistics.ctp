...
function setTaskStateData(jsonObj){
	...
	<?php 
	if (!TASK_AUDIT_TYPE):
	     $Num = TASK_AUDIT_AUDIT_LEVEL;
	else :
	     $Num = TASK_CONTENT_AUDIT_LEVEL>TASK_TECH_AUDIT_LEVEL ? TASK_CONTENT_AUDIT_LEVEL : TASK_TECH_AUDIT_LEVEL;
	endif;
	?>
    ...
    if(chart2Data.length==1){
    	chart2Data[0]['state'] = "待审核";
    }

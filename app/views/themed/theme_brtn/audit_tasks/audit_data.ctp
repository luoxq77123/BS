...
<!--			<div class="fr">-->
<!--				<span>审核模式</span><a href="javascript:void(0);" onclick="onSetLock(2)"></a>-->
<!--			</div>-->
		</div>
...
<script type="text/javascript"><!-- 
   ...
   function onSetLock(value,tag){
       ...
       if(value!=0){
        ...
        var datas = "";
 	    <?php if($taskInfo['taskid']):?>
 	    datas = "TaskID="+<?php echo $taskInfo['taskid'];?>+"&SetID="+value; 	   
        ...
        $.ajax({
			   ...
			   success: function(msg){
			      if(value==1){
			    	  ...
			    	  url = "<?php echo $this->Html->url(array('controller' => 'audit_tasks','action' => 'browseData',$taskInfo['taskid'],'cmode'=>$layoutParams['model'],'cpage'=>$layoutParams['page']));?>";
			    	  location.href = url;
			      }		
			      else if(value==3){
